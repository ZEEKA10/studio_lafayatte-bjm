...
<head>
    ...
    <title>Tambah Paket Foto - Lafayette Admin</title>
            ...
            <div class="col-md-8 animasi-masuk" style="animation-delay: 0.1s; opacity: 0;">
                <div class="card card-custom">
                    <div class="card-header bg-cokelat card-header-custom text-center text-white">
                        <h4 class="mb-0 judul-elegan">➕ Tambah Paket Foto Baru</h4>
                    </div>
                    <div class="card-body p-4 p-md-5">
                        <form action="{{ route('packages.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="mb-4">
                                ...
                                <input type="text" name="kategori" class="form-control" placeholder="Contoh: Single - Profile" required>
                                <div class="form-text mt-2 text-muted">Paket dengan nama kategori yang persis sama akan otomatis dikelompokkan.</div>
                            </div>
                            
                            <div class="mb-4">
                                <label class="form-label fw-bold text-cokelat">Nama Paket (Tipe)</label>
                                <input type="text" name="nama_paket" class="form-control" placeholder="Contoh: Basic atau Special" required>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-4">
                                    ...
                                    <input type="number" name="jumlah_slot" class="form-control" min="1" placeholder="1 slot = 30 Menit" required>
                                </div>
                            </div>

                            <div class="mb-4">
                                <label class="form-label fw-bold text-cokelat">Deskripsi Fasilitas</label>
                                <div class="form-text text-muted mb-2">Pisahkan setiap fasilitas dengan tombol <b>Enter</b>. Di halaman booking otomatis akan menjadi titik (bullet).</div>
                                <textarea name="deskripsi" class="form-control" rows="6" placeholder="Contoh:&#10;15 foto edit pilihan&#10;6 cetak 5R"></textarea>
                            </div>

                            <div class="mb-4">
                                <label class="form-label fw-bold text-cokelat">Gambar Paket</label>
                                <input type="file" name="gambar" class="form-control">
                                <div class="form-text">
                                    Upload gambar paket (JPG, JPEG, PNG)
                                </div>
                            </div>
                            ...
                            <div class="d-flex justify-content-between mt-5 pt-4 border-top" style="border-color: #F0E6DD !important;">
                                ...
                                <button type="submit" class="btn btn-cokelat fw-bold">Simpan Paket</button>
                            </div>
                        </form>
                    </div>
                </div>
